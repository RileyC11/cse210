...
namespace W09_Prove_tron_game.Game.Scripting
{
    ...
    public class HandleCollisionsAction : Actions
    {
        ...
        private void HandleGrowingTail(Cast cast)
        {
                ...
                Point head1Position = head1.GetPosition();
                snake.GrowTail(headPosition);
                snake1.GrowTail(head1Position);
