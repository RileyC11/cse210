...
using W11_Prove_Final_galaga_game.Game.Directing;
using W11_Prove_Final_galaga_game.Game.Services;


namespace W11_Prove_Final_galaga_game
{
    /// <summary>
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            bullet.SetText("|");
            bullet.SetFontSize(FONT_SIZE);
            bullet.SetColor(WHITE);
            bullet.SetPosition(new Point(MAX_X/2, MAX_Y - 15));
