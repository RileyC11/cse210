...
namespace W12_Final_tanks_game.Game.Scripting
{
    ...
    public class HandleCollisionsAction : Action
    {
        ...
        {
            HandleBulletTankCollision(cast);
            HandleBulletBorderCollision(cast);
            // HandleCollision(cast);
            HandleBulletWallCollision(cast);
            // HandleActorCollision(cast);
        }
        ...
        public void HandleBulletBorderCollision(Cast cast)
        {
            Actor bullet1 = (Actor)cast.GetFirstActor("bullet1");
            Point bullet1Pos = bullet1.GetPosition();
            int bullet1X = bullet1Pos.GetX();
        ...
        // public void HandleActorCollision(Cast cast)
        // {
